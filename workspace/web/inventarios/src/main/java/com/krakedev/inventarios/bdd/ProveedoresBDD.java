...
public class ProveedoresBDD {
	...
	public ArrayList<Proveedor> buscarPorNombre(String subcadena) throws KrakedevException {
		...
		try {
			...
			ps = con.prepareStatement(
					"select prov.identificador,tipo_documento,td.descripcion,prov.nombre,prov.telefono,prov.correo,prov.direccion"
							+ " from proveedores prov, tipo_documento td " + " where prov.tipo_documento = td.codigo"
	...
	public ArrayList<Proveedor> buscarPorIdentificador(String subcadena) throws KrakedevException {
		ArrayList<Proveedor> proveedores = new ArrayList<Proveedor>();
		Connection con = null;
		PreparedStatement ps = null;
		ResultSet rs = null;
